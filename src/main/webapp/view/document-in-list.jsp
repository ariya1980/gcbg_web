...
<script src="<%= request.getContextPath() %>/js/document-in-list.js" type="text/javascript"></script>
<style>
td.details-control {
    background: url('<%= request.getContextPath() %>/assets/images/plus.png') no-repeat center center;
    background-size: 16px;
    cursor: pointer;
}
tr.shown td.details-control {
    background: url('<%= request.getContextPath() %>/assets/images/minus.png') no-repeat center center;
    background-size: 16px;
}
</style>
</head>
...
<div class="container" style="background-color: #fff;">
	<br>
		<div class="card-main">
			<div class="card-body">
				<h1 class="text-head">
					<i class="fas fa-file-alt"></i> Document List In
				</h1>
