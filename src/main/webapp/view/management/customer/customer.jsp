...
<script src="<%= request.getContextPath() %>/js/management/customer.js" type="text/javascript"></script>
		...
		<div class="card-main">
			<div class="card-body">
				...
				<div class="row">
					<div class="col-8">
						<h1 class="text-head">
							<i class="fas fa-cogs"></i> Customer Management
						</h1>
					</div>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							<label class="text-secondary">Customer Code</label><br> <select
